...
__all__ = ['DateRange', 'parse_date_range']
...
def parse_date_range(date_range: str) -> DateRange:
    r"""
...
if __name__ == '__main__':
    print(parse_date_range("2020-01-10"))
    print(parse_date_range("2020-01-10:"))
    print(parse_date_range(":2020-01-10"))
    print(parse_date_range("2019-01-01:2020-01-10"))
    print(parse_date_range("2020-01-01:2019-01-10"))
